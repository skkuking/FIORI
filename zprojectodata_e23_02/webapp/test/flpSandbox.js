		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "odata connect",
									"targetURL": "#zprojectodatae2302-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zprojectodatae2302-display": {
								"semanticObject": "zprojectodatae2302",
								"action": "display",
								"description": "A Fiori application. connect odata",
								"title": "odata connect",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zprojectodatae2302",
									"url": sap.ui.require.toUrl("zprojectodatae2302")
								}
							}
						}
					}

		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "practice JSON",
									"targetURL": "#zprojectteste2304-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zprojectteste2304-display": {
								"semanticObject": "zprojectteste2304",
								"action": "display",
								"description": "A Fiori application for JSON PRACTICE",
								"title": "practice JSON",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zprojectteste2304",
									"url": sap.ui.require.toUrl("zprojectteste2304")
								}
							}
						}
					}

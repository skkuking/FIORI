		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Chart",
									"targetURL": "#zprojectteste2308-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zprojectteste2308-display": {
								"semanticObject": "zprojectteste2308",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zprojectteste2308",
									"url": sap.ui.require.toUrl("zprojectteste2308")
								}
							}
						}
					}

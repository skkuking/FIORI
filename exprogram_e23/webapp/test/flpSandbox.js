		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#exprograme23-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"exprograme23-display": {
								"semanticObject": "exprograme23",
								"action": "display",
								"description": "Exam",
								"title": "App Title",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exprograme23",
									"url": sap.ui.require.toUrl("exprograme23")
								}
							}
						}
					}

		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ERzferreadslip-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ERzferreadslip-display": {
								"semanticObject": "ERzferreadslip",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ER.zferreadslip",
									"url": sap.ui.require.toUrl("ER/zferreadslip")
								}
							}
						}
					}

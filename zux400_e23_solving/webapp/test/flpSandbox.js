		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ux400 문제",
									"targetURL": "#sapbtpzux400e23solving-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpzux400e23solving-display": {
								"semanticObject": "sapbtpzux400e23solving",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.zux400e23solving",
									"url": sap.ui.require.toUrl("sap/btp/zux400e23solving")
								}
							}
						}
					}

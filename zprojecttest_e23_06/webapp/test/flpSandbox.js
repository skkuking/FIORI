		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zprojectteste2306-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zprojectteste2306-display": {
								"semanticObject": "zprojectteste2306",
								"action": "display",
								"description": "A Dynamic Page exercise",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zprojectteste2306",
									"url": sap.ui.require.toUrl("zprojectteste2306")
								}
							}
						}
					}

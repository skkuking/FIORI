		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "polypenol",
									"targetURL": "#zprojectteste2303-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zprojectteste2303-display": {
								"semanticObject": "zprojectteste2303",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zprojectteste2303",
									"url": sap.ui.require.toUrl("zprojectteste2303")
								}
							}
						}
					}

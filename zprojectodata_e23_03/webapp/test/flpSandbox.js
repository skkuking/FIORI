		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "North Wind",
									"targetURL": "#ntzprojectodatae2303-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ntzprojectodatae2303-display": {
								"semanticObject": "ntzprojectodatae2303",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nt.zprojectodatae2303",
									"url": sap.ui.require.toUrl("nt/zprojectodatae2303")
								}
							}
						}
					}

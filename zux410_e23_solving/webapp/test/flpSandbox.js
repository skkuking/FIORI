		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UX410 문제",
									"targetURL": "#sapbtpzux410e23solving-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpzux410e23solving-display": {
								"semanticObject": "sapbtpzux410e23solving",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.zux410e23solving",
									"url": sap.ui.require.toUrl("sap/btp/zux410e23solving")
								}
							}
						}
					}

		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#C05zprojectteste2302-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"C05zprojectteste2302-display": {
								"semanticObject": "C05zprojectteste2302",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=C05.zprojectteste2302",
									"url": sap.ui.require.toUrl("C05/zprojectteste2302")
								}
							}
						}
					}
